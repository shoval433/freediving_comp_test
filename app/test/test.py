...
r = requests.post('http://43.0.20.203:5001/comp1', data=data)
assert r.status_code == 200

# Test getting a diver
r = requests.get('http://43.0.20.203:5001/comp1')
assert r.status_code == 200
...
data = {'firstName': 'Jane'}
r = requests.put('http://43.0.20.203:5001/comp1', data=data)
assert r.status_code == 200
divers = json.loads(r.text)
assert divers[0]['firstName'] == 'Jane'

# Test deleting a diver
r = requests.delete('http://43.0.20.203:5001/comp1/1')
assert r.status_code == 200
